...
public class WaterSprinkler extends AbstractGrowthAccelerator {
    ...
    private static final CustomItemStack noWaterItem = CustomItemStack.create(Material.BUCKET,
        "&cNo water found",
        "",
        "&cPlease place water under the sprinkler!"
    );
    private static final CustomItemStack waterFoundItem = CustomItemStack.create(Material.WATER_BUCKET,
        "&bWater detected"
    );
