...
[![bStats](https://bStats.org/signatures/bukkit/FluffyMachines.svg)](https://bStats.org/plugin/bukkit/FluffyMachines/31443)
...
dependencies {
    "githubCompileOnly"("Slimefun5:FluffyMachines:v1.22.2.8")
}
```
